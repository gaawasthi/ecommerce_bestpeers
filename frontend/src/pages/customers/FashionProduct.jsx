...
import { getFashionProducts } from '../../features/products/productSlice';
...
const FashionProduct = () => {
  ...
  const { fashion, isLoading, error } = useSelector((state) => state.product);
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-8">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Latest Fashion</h1>
